...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open(['route' => 'admin_questions_add_post', 'class' => 'form-horizontal', 'role' => 'form', 'files' => true]) !!}
                    @if (isset($failed))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="question_title" id="question_title" placeholder="Pregunta" class="col-xs-10 col-sm-5" required/>
                        </div>
                    </div>

                <div class="form-group question_answers_div">
                        <span class="answers">
                            <label class="col-sm-3 control-label no-padding-right"> Respuestas </label>
                            <div class="col-sm-9">
                                <input type="text" id="question_answers" name="question_answers[]" placeholder="Respuesta" class="col-xs-10 col-sm-5" required/>
                                <div class="col-sm-3">
                                    <div class="radio">
                                        <label>
                                            <input name="correct_answer[]" type="radio" class="ace" value="0" checked>
               ...
               var toAppend = '<span class="answers"> \
                                    ...
                                    <div class="col-sm-9"> \
                                        ...
                                        <div class="col-sm-3"> \
                                            <div class="radio"> \
                                                <label> \
                                                    <input name="correct_answer[]" type="radio" value="'+$(".answers").length+'" class="ace"> \
                                                    <span class="lbl"> Correcta</span> \
                                                </label> \
                                            </div> \
                                        </div> \
