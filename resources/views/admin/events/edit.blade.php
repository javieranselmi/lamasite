...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open(['route' => ['events.update', $event->id], 'class' => 'form-horizontal', 'role' => 'form', 'files' => true]) !!}
                {{ method_field('PUT') }}
                @if (isset($failed))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" id="title" placeholder="Titulo"
                               value="{{ $event->title }}" class="col-xs-10 col-sm-5" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="description" id="description"
                                  class="autosize-transition form-control" required>{{ $event->description }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='input-group date' id='datetimepicker'>
                            <input type='text' id="event_at" name="event_at" class="form-control" value="{{ $event->event_at }}" />
