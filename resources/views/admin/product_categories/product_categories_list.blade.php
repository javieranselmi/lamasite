...
@section('title', 'Administrar Categorias Productos')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="blue" href="{{ route('product_categories_detail', ['prouduct_category_id' => $product_category->id]) }}" target="_blank">
                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                            </a>

                                            <a class="green" href="{{ route("admin_product_categories_edit", ["product_category_id" => $product_category->id]) }}">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a class="red delete_category" href="{{ route('admin_product_categories_delete', ['product_category_id' => $product_category->id]) }}">
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, conf ) {
                            window.open("{{ route('admin_product_categories_add') }}", "_self");
                        }
                    },
                    {
                        "extend": "colvis",
