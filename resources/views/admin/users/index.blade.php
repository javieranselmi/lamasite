                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a class="red delete_user"
                                           href="{{ route('users.destroy', ['user_id' => $user->id]) }}">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            new $.fn.dataTable.Buttons(myTable, {
                buttons: [
                    {
                        "text": "<i class='fa fa-plus bigger-110 green'></i> <span class='hidden'>Nuevo Usuario</span>",
                        "className": "btn btn-white btn-primary btn-bold",
                        columns: ':not(:first):not(:last)',
                        action: function (e, dt, node, conf) {
                            window.open("{{ route('users.create') }}", "_self");
                        }
                    },
                    {
                        "extend": "colvis",
            ...
            $(document).ready(function () {
                ...
                $('#dynamic-table').on('click', '.delete_user', deleteResource);
            });
        });
    </script>
@endsection